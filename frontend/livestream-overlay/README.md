...
- ✅ **RTSP Stream Support** - Convert and play RTSP streams in browser
- ✅ **Real-time Overlays** - Add text and image overlays on video
- ✅ **Drag & Drop** - Freely position overlays anywhere on video
- ✅ **Resizable** - Adjust overlay size with mouse
...
│   ├── stream_rtsp.py         # RTSP to HLS converter
│   ├── requirements.txt       # Python dependencies
│   └── stream/                # HLS output directory (auto-created)
│       ├── stream.m3u8        # Generated by FFmpeg
│       └── stream*.ts         # Generated by FFmpeg
│
├── frontend/
│   ├── src/
...
**Expected Output:**
```
🎥 Starting RTSP to HLS conversion...
📍 RTSP URL: rtsp://...
📂 Output: stream/stream.m3u8

⚠️  Press Ctrl+C to stop streaming

📊 frame= 1234 fps= 30 time=00:00:41.23 ...
```
...
- **Delete Selected**: Click an overlay, then click "🗑️ Delete Selected"
- **Reset All**: Click "♻️ Reset All" to delete all overlays (requires confirmation)
...
1. ✅ Starting all services (MongoDB, FFmpeg, Flask, React)
2. ✅ Video playing from RTSP source
3. ✅ Creating text overlay
4. ✅ Editing text content
5. ✅ Moving overlay (drag)
6. ✅ Resizing overlay
7. ✅ Uploading image overlay
8. ✅ Deleting overlay
9. ✅ Showing MongoDB data persistence (refresh page)
...
**Built with ❤️ for real-time video streaming**